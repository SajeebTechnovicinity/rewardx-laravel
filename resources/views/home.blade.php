...
@section('content')
        ...
        <div class="dashboard-content">
            <div class="dashboard-content__topbar topbar flex-ctr">
            ...
            <div class="dashboard-content__title-bar title-bar">
                <h3 class="title">Dashboard</h3>
            </div>
            <div class="dashboard-main-content-wrap">
                <div class="dashboard-main-content">
                    <div class="cards dashboard-main-content__cards flex-start-spb">
                        <div class="card flex-ctr card-1">
                            <div class="card__icon flex-ctr-ctr">
                            ...
                            <div class="card__text">
                                <p class="card__text-sub">Total Transaction</p>
                                <h3 class="card__text-main">$2.7k</h3>
                            </div>
                        </div>
                        <div class="card flex-ctr card-2">
                            <div class="card__icon flex-ctr-ctr">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="Iconly/Bulk/Notification">
                            ...
                            <div class="card__text">
                                <p class="card__text-sub">Transaction this month</p>
                                <h3 class="card__text-main">$6.4k</h3>
                            </div>
                        </div>
                        <div class="card flex-ctr card-3">
                            <div class="card__icon flex-ctr-ctr">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="Iconly/Bulk/Notification">
                            ...
                            <div class="card__text">
                                <p class="card__text-sub">Transaction this month 2</p>
                                <h3 class="card__text-main">$6.4k</h3>
                            </div>
                        </div>
                        <div class="card flex-ctr card-4">
                            <div class="card__icon flex-ctr-ctr">
                            ...
                            <div class="card__text">
                                <p class="card__text-sub">Transaction this month 3</p>
                                <h3 class="card__text-main">$6.4k</h3>
                            </div>
                        </div>
                    </div>
