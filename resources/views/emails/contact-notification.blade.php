...
<body class="body" id="body" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="#44C4C7" style="
    ...
    ">
    <!-- BEGIN: CONTAINER -->
    <table class="container container_full" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse; min-width: 100%" role="presentation">
        <tbody>
            <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="section_wrapper_th" style="
                                                            ...
                                                            padding-bottom: 26px;
                                                        " bgcolor="#ffffff">
                                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="
                                                                min-width: 100%;
                                                            " role="presentation">
                                                            <tbody>
                                                                <tr>
                                                                    <th class="column_logo" style="
                                                                        ...
                                                                        <a href="#" target="_blank" style="
                                                                                ...
                                                                                text-underline: none;
                                                                            ">
                                                                            <img src="{{ asset('logo.png') }}" class="logo" width="150" border="0" style="
                                                                                    width: 150px;
                                                                                    height: auto !important;
                                                                                    display: block;
                                                                                    text-align: center;
                                                            ...
                                                            <tbody>
                                                                <tr id="section-1468266" class="section heading">
                                                                    <th style="
                                                                            ...
                                                                            padding: 26px
                                                                                ...
                                                                                13px;
                                                                        " bgcolor="#ffffff">
                                                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" role="presentation" style="
                                                                                color: #4b4b4b;
                                                                            " bgcolor="#ffffff">
                                                                            <tbody>
                                                                                <tr style="
                                                                                    ...
                                                                                    <th style="
                                                                                        ...
                                                                                        <h1 data-key="1468266_heading" style="
                                                                                                font-family: Georgia,
                                                                                                    serif,
                                                                                                    'Playfair Display';
                                                                                                font-size: 28px;
                                                                ...
                                                                <tr id="section-1468267" class="section introduction">
                                                                    <th style="
                                                                        ...
                                                                        <p data-key="1468267_introduction_text" class="text" style="
                                                                                mso-line-height-rule: exactly;
                                                                                font-family: -apple-system,
                                                                                    BlinkMacSystemFont,
                                                                                    'Segoe UI',
